        ...
        private void Initialize()
        {
            ...
            alignHorizontalLeftButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalAlignLeft)
            ...
            alignHorizontalCenterButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalAlignCenter)
            ...
            alignHorizontalRightButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalAlignRight)
            ...
            alignVerticalTopButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalAlignTop)
            ...
            alignVerticalCenterButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalAlignCenter)
            ...
            alignVerticalBottomButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalAlignBottom)
            ...
            alignModeInsideButton =
                GetAlignModeButton(AlignMode.Inside)
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.AlignModeInside)
            ...
            alignModeCenterButton =
                GetAlignModeButton(AlignMode.Center)
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.AlignModeCenter)
            ...
            alignModeOutsideButton =
                GetAlignModeButton(AlignMode.Outside)
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.AlignModeOutside)
            ...
            distributeHorizontalLeftButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalDistributeLeft)
            ...
            distributeHorizontalCenterButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalDistributeCenter)
            ...
            distributeHorizontalRightButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.HorizontalDistributeRight)
            ...
            distributeVerticalTopButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalDistributeTop)
            ...
            distributeVerticalCenterButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalDistributeCenter)
            ...
            distributeVerticalBottomButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.VerticalDistributeBottom)
            ...
            verticalDistributeSpacingButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.DistributeSpacingVertical)
            ...
            horizontalDistributeSpacingButton =
                GetButton()
                    ...
                    .SetIcon(EditorTextures.UIDesigner.Icons.DistributeSpacingHorizontal)
            ...
            alignToRootCanvasButton =
                GetAlignToButton(AlignTo.RootCanvas, "Align to Root Canvas")
                    .SetIcon(EditorTextures.UIDesigner.Icons.RootCanvas)
                    .SetTabPosition(TabPosition.TabOnLeft)
                    .SetTooltip
                    (
            ...
            alignToParentButton =
                GetAlignToButton(AlignTo.Parent, "Align to Parent")
                    .SetIcon(EditorTextures.UIDesigner.Icons.Parent)
                    .SetTabPosition(TabPosition.TabInCenter)
                    .SetTooltip
                    (
                        "Align To: Parent\n\n" +
            ...
            alignToSelectionButton =
                GetAlignToButton(AlignTo.Selection, "Align to Selection")
                    .SetIcon(EditorTextures.UIDesigner.Icons.Selection)
                    .SetTabPosition(TabPosition.TabOnRight)
                    .SetTooltip
                    (
                        "Align To: Selection\n\n" +
            ...
            alignToKeyObjectButton =
                GetAlignToButton(AlignTo.KeyObject, "Align to Key Object")
                    .SetIcon(EditorTextures.UIDesigner.Icons.KeyObject)
                    .SetTabPosition(TabPosition.TabOnLeft)
                    .SetTooltip
                    (
                        "Align To: Key Object\n\n" +
